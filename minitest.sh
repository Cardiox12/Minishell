...
test_command 'cat makefile < main.c | grep include | grep inc < includes/eval.h' 
#set -x
#result_command=`cat makefile < main.c | grep include | grep inc < includes/eval.h`
#printf "result : %s\n" "$result_command"
#test_complex_command "cat makefile < main.c | grep include | grep inc < includes/eval.h" "$result_command"
#cat makefile < main.c | grep include | grep inc < includes/eval.h
#cat makefile | grep include < includes/eval.h
#echo "hello include" | grep include includes/eval.h
#echo "hello include" | grep include #< includes/eval.h